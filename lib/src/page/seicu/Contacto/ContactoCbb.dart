...
class ContactosCbbPage extends StatefulWidget {
  static final String routeName = 'contactos';
  ContactosCbbPage({Key key}) : super(key: key);

  @override
  _ContactosCbbPageState createState() => _ContactosCbbPageState();
}

class _ContactosCbbPageState extends State<ContactosCbbPage> {
  ...
  @override
  void initState() {
    prefs.lastPage = ContactosCbbPage.routeName;
    super.initState();
  }
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    showInformationBasic(
                      context,
                      'QUIERES COMUNICARTE CON EL MUNICIPIO DE ${prefs.departament.toString().toUpperCase()}?',
