...
class MunicipioCbbPage extends StatefulWidget {
  MunicipioCbbPage({Key key}) : super(key: key);

  @override
  _MunicipioCbbPageState createState() => _MunicipioCbbPageState();
}

class _MunicipioCbbPageState extends State<MunicipioCbbPage> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  Shimmer.fromColors(
                    ...
                    child: Text('ACERCA DEL MUNICIPIO ${prefs.departament.toString().toUpperCase()}',
        ...
        SizedBox(
          ...
          child: RaisedButton(
            ...
            onPressed: () => navegation(context,
                ViewPage(title: 'SEICU DIGITAL'.toString(), url: facebookTorno)),
            child: Icon(
